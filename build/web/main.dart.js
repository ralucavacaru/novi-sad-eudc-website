...
if(b==null)b=C.cn}z=!!J.w(a).$isbg?a:$.$get$D().l(0,a)
y=this.ly(b)
x=H.it(z,y)
return x},
...
K.mP()
z=[null]
z=[C.ck,new Y.am(C.a2,C.a0,"__noValueProvided__",null,null,null,!1,z),new Y.am(C.L,C.L,"__noValueProvided__",null,null,null,!1,z)]
y=z.length
x=y!==0?[C.ap,z]:C.ap
w=$.fC
w=w!=null&&!w.c?w:null
...
C.cG=new N.r3(C.cx)
C.cl=I.r([C.cG])
C.bi=new D.a8("my-app",V.wp(),C.q,C.cl)
C.B=H.q("cH")
...
C.cw=I.r([C.bp])
C.bX=I.r([C.cw])
C.bH=I.r(['.landing-image._ngcontent-%COMP% { background-image:url("packages/novi_sad_eudc/assets/img/novi-sad-banner.jpg"); }',C.n])
C.k=I.r([C.bH])
C.as=new S.bm("AppId")
C.bn=new B.bK(C.as)
C.bO=I.r([C.bn])
...
C.cv=I.r([C.bV])
C.cA=I.r(['.landing-image._ngcontent-%COMP% { background-image:url("packages/novi_sad_eudc/assets/img/novi-sad-banner.jpg"); } .ca-img._ngcontent-%COMP% { width:100%; } .fixed-column._ngcontent-%COMP% { max-width:300px; min-width:300px!important; padding:20px; } .fixed-column._ngcontent-%COMP% p._ngcontent-%COMP% { text-align:left!important; } .fixed-column._ngcontent-%COMP% h2._ngcontent-%COMP% { font-size:25px; } @media ONLY screen AND (max-width:760px){ .fixed-column._ngcontent-%COMP% { min-width:200px!important; } } @media ONLY screen AND (max-width:400px){ .fixed-column._ngcontent-%COMP% { min-width:150px!important; } }',C.n])
C.cy=I.r([C.cA])
...
C.cz=I.r([C.bD,C.d1,C.d5,C.N,C.d8,C.d2])
C.aG=H.q("Aa")
...
C.U=H.q("dU")
C.ct=I.r([C.cz,C.bF,C.da,C.a_,C.a1,C.R,C.cY,C.cX,C.U,C.Q])
...
C.co=H.z(I.r([]),[P.cN])
C.aq=new H.hA(0,{},C.co,[P.cN,null])
